const sentenze = ['a chissu fra tri ghionna mori', 'Attento alla DELTAAAAAAAA', 'viri ca ci su petri na lenticchiaaaaa', "te l'hau rittu iu!", 'a rilla quacchi cosa!', 'a mettiti sa spacchiu ri mascherina!'];
